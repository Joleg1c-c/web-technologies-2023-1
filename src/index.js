...
const game = {
  ...
  canSetDirection(direction) {
    ...
    return !((snakeDirection == "up" && direction == "down") || (snakeDirection == "down" && direction == "up") || 
          (snakeDirection == "left" && direction == "right") || (snakeDirection == "right" && direction == "left")) && (direction != "");
  },
   ...
   */
  isGameWon() {
    return snake.bodyLenght - 1 >=this.config.getWinFoodCount();
  },
